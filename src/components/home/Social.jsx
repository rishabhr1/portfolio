...
const Social = () => {
  return (
    <div className="home__social">
        ...
        <a href="https://www.linkedin.com/in/rishabh-raj-001" className="home__social-icon" target="_blank">
            <i className="uil uil-linkedin-alt"></i>
        </a>

        <a href="https://github.com/rishabhr1" className="home__social-icon" target="_blank">
